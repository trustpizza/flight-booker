...
flights = Flight.create([{dep_time: Time.now, dep_date: Date.today, duration: 120, departure_airport: airports[0], arrival_airport: airports[1]}, 
  ...
  {dep_time: Time.now, dep_date: Date.today +300 , duration: 120, departure_airport: airports[0], arrival_airport: airports[3]},
  ...
  {dep_time: Time.now, dep_date: Date.today +300 , duration: 120, departure_airport: airports[1], arrival_airport: airports[3]},
  ...
  {dep_time: Time.now, dep_date: Date.today +300 , duration: 120, departure_airport: airports[2], arrival_airport: airports[3]},
  ...
  {dep_time: Time.now, dep_date: Date.today +300 , duration: 120, departure_airport: airports[3], arrival_airport: airports[2]},
  ...
  {dep_time: Time.now, dep_date: Date.today +300 , duration: 120, departure_airport: airports[4], arrival_airport: airports[2]},
  ...
  {dep_time: Time.now, dep_date: Date.today +300 , duration: 120, departure_airport: airports[5], arrival_airport: airports[2]},
